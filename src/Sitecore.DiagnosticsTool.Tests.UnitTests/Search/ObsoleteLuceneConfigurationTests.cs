namespace Sitecore.DiagnosticsTool.Tests.UnitTests.Search
{
  ...
  public class ObsoleteLuceneConfigurationTests : ObsoleteLuceneConfiguration
  {
    [Fact]
    ...
    public void Problem()
    {
      UnitTestContext
        ...
        .Process(this)
        .MustReturn(new TestOutput(TestResultState.Warning, "ContentSearch configuration uses obsolete LuceneSearchConfiguration that may lead to unpredictable behavior."))
        .Done();
    }
  }
}
