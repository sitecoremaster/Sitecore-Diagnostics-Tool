namespace Sitecore.DiagnosticsTool.Resources.SitecoreInformation.UnitTests
{
  ...
  public class ModulesContextTests
  {
    ...
    public void Test()
    {
      ...
      {
        // SC 8.2.1
        new AssemblyFile("Antlr3.Runtime.dll", "3.5.0.2", "3.5.0.2", 103424),
        new AssemblyFile("Sitecore.Kernel.dll", "10.0.0.5597", "10.0.0 rev. 160729", 5159224),
        ...
        new AssemblyFile("Sitecore.Sharepoint.Data.WebServices.dll", "2.1.5049", " 2.1 rev. 150128", 203264),
        ...
        // WFFM 
        new AssemblyFile("Sitecore.Forms.Mvc.dll", "8.2.5600.0", "8.2 rev. 160801", 117248),
      };
      ...
      Assert.Equal(150128, correctModule.Value?.Release?.Version.Revision);
      ...
      Assert.Equal(160801, incorrectModule.Value?.Release?.Version.Revision);
